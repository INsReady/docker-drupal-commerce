...
-	[`8.4-2.x`, `latest` (*Dockerfile*)](https://github.com/INsReady/docker-drupal-commerce/blob/master/8.4/Dockerfile)
-	[`8.x-2.0-RC3` (*Dockerfile*)](https://github.com/INsReady/docker-drupal-commerce/blob/8.x-2.0-RC3/8.4/Dockerfile)
